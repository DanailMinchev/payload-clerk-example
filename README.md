...
5. Trigger a test event from the dashboard. The handler in `src/app/(frontend)/api/webhooks/clerk/route.ts` verifies the signature with `verifyWebhook` and logs the event - extend it to write into your database.
